...
class ServerDemoService {
  ...
  Future<bool> onboard({String atsign}) async {
    ...
    var result = await atClientServiceInstance.onboard(
        atClientPreference: atClientPreference, atsign: atsign, namespace: conf.namespace);
  ...
  Future<bool> authenticate(String atsign, {String cramSecret, String privateKey}) async {
    var result = await atClientServiceInstance.authenticate(atsign, cramSecret: cramSecret);
    atClientInstance = atClientServiceInstance.atClient;
    return result;
  }
  ...
  Future<List<String>> getKeys({String sharedBy}) async {
    return await this.atClientInstance.getKeys(regex: conf.namespace, sharedBy: sharedBy);
  }
}
